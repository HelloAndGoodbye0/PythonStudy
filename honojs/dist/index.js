...
var require_errors = __commonJS({
  "node_modules/logform/errors.js"(exports, module) {
    ...
    var format2 = require_format();
    var { LEVEL, MESSAGE } = require_triple_beam();
    module.exports = format2((einfo, { stack, cause }) => {
...
var require_json = __commonJS({
  "node_modules/logform/json.js"(exports, module) {
    ...
    module.exports = format2((info, opts) => {
  ...
  "node_modules/@so-ric/colorspace/dist/index.cjs.js"(exports, module) {
    ...
    cs.get.rgb = function(string) {
      ...
      if (match2 = string.match(hex2)) {
        ...
        if (!Object.hasOwn(cssKeywords, match2[1])) {
          return null;
        }
        rgb = cssKeywords[match2[1]];
        rgb[3] = 1;
        return rgb;
      } else {
        return null;
    ...
    module.exports = class File extends TransportStream {
      ...
      query(options, callback) {
        ...
        function check(log2) {
          ...
          const time2 = new Date(log2.timestamp);
          if (options.from && time2 < options.from || options.until && time2 > options.until || options.level && options.level !== log2.level) {
            return;
          }
          return true;
        }
    ...
    var Logger = class extends Transform {
      ...
      remove(transport) {
        ...
        if (!isStream(transport) || transport.log.length > 2) {
          target = this.transports.filter(
            (match2) => match2.transport === transport
          )[0];
        }
        if (target) {
          this.unpipe(target);
      ...
      profile(id, ...args) {
        ...
        if (this.profilers[id]) {
          ...
          const info = typeof args[args.length - 1] === "object" ? args.pop() : {};
          info.level = info.level || "info";
          info.durationMs = time2 - timeEnd;
          info.message = info.message || id;
          return this.write(info);
        }
        this.profilers[id] = time2;
        return this;
      }
      /**
...
var createUserSchema = external_exports.object({
  name: external_exports.string().min(1, "\u7528\u6237\u540D\u4E0D\u80FD\u4E3A\u7A7A").max(50, "\u7528\u6237\u540D\u4E0D\u80FD\u8D85\u8FC750\u4E2A\u5B57\u7B26"),
  email: external_exports.string().email("\u90AE\u7BB1\u683C\u5F0F\u4E0D\u6B63\u786E"),
  age: external_exports.number().min(0, "\u5E74\u9F84\u4E0D\u80FD\u5C0F\u4E8E0").max(150, "\u5E74\u9F84\u4E0D\u80FD\u5927\u4E8E150").optional()
});
var updateUserSchema = external_exports.object({
  name: external_exports.string().min(1, "\u7528\u6237\u540D\u4E0D\u80FD\u4E3A\u7A7A").max(50, "\u7528\u6237\u540D\u4E0D\u80FD\u8D85\u8FC750\u4E2A\u5B57\u7B26").optional(),
  email: external_exports.string().email("\u90AE\u7BB1\u683C\u5F0F\u4E0D\u6B63\u786E").optional(),
  age: external_exports.number().min(0, "\u5E74\u9F84\u4E0D\u80FD\u5C0F\u4E8E0").max(150, "\u5E74\u9F84\u4E0D\u80FD\u5927\u4E8E150").optional()
});
...
var loginSchema = external_exports.object({
  username: external_exports.string().min(1, "\u7528\u6237\u540D\u4E0D\u80FD\u4E3A\u7A7A"),
  password: external_exports.string().min(6, "\u5BC6\u7801\u4E0D\u80FD\u5C11\u4E8E6\u4E2A\u5B57\u7B26")
});
var registerSchema = external_exports.object({
  username: external_exports.string().min(3, "\u7528\u6237\u540D\u4E0D\u80FD\u5C11\u4E8E3\u4E2A\u5B57\u7B26").max(20, "\u7528\u6237\u540D\u4E0D\u80FD\u8D85\u8FC720\u4E2A\u5B57\u7B26"),
  password: external_exports.string().min(6, "\u5BC6\u7801\u4E0D\u80FD\u5C11\u4E8E6\u4E2A\u5B57\u7B26").max(50, "\u5BC6\u7801\u4E0D\u80FD\u8D85\u8FC750\u4E2A\u5B57\u7B26"),
  email: external_exports.string().email("\u90AE\u7BB1\u683C\u5F0F\u4E0D\u6B63\u786E").optional()
});
...
routes.route("/user", user_default);
...
var logFileName = `app-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.log`;
...
serve({
  ...
  winstonLogger.info(`\u{1F680} \u670D\u52A1\u5668\u8FD0\u884C\u5728 http://localhost:${info.port}`);
  winstonLogger.info(`\u{1F4DD} \u73AF\u5883: ${process.env.NODE_ENV || "development"}`);
  winstonLogger.info(`\u{1F4C4} \u65E5\u5FD7\u6587\u4EF6: ${logFilePath}`);
});
